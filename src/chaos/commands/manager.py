...
* Every outcome -- accepted, rejected, timed out, overridden, superseded,
  cancelled -- is written to :class:`~chaos.models.commands.Command`
...
from chaos.envelope import CommandAckEnvelope, CommandEnvelope
...
class ServiceActor:
    ...
    def has_role(self, minimum: str) -> bool:  # pragma: no cover - parity with Principal
        from chaos.commands.interlocks import role_at_least
