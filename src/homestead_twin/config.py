...
# Repository root: <root>/src/homestead_twin/config.py -> parents[2]
...
class Settings(BaseSettings):
    ...
    mqtt_tls: bool = False
    mqtt_client_id: str = "homestead-twin-core"
    mqtt_base_topic: str = "homestead"
    ...
    api_port: int = 8000
    api_title: str = "Homestead Digital Twin API"
    api_root_path: str = ""
