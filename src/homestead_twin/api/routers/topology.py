...
Two rules, inherited from :mod:`homestead_twin.api.routers.overview`:
...
2. **Nothing is fabricated.** The availability vocabulary is
   :data:`~homestead_twin.api.routers.overview.STATUS_EXPLANATIONS` verbatim,
...
:class:`homestead_twin.alarms.correlation.DependencyGraph` and its
:data:`~homestead_twin.alarms.correlation.DOWNSTREAM_EDGE_TYPES` direction table
