...
The distribution and import package remain ``homestead-twin`` /
``homestead_twin``: CHAOS is the project name, and renaming the module would
churn every import and test for no functional gain.
"""

PROJECT_NAME = "Project CHAOS"
PROJECT_LONG_NAME = "Central Homestead Automation and Operation System"
