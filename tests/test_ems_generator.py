...
def test_unavailable_generator_blocks_the_start_and_alarms(coordinator, config, port, bus):
    ...
    message = bus.last(f"homestead/energy/site/generator_01/alarm/generator_start_blocked")
...
def test_full_start_run_stop_cycle(coordinator, config, port, bus):
    ...
    stopped = bus.last(f"homestead/energy/site/generator_01/alarm/generator_stopped")
...
def test_rejected_start_request_is_handled(config, settings, bus):
    ...
    message = bus.last(f"homestead/energy/site/generator_01/alarm/generator_start_failed")
