...
2. **Dependency correlation.** The registry's typed relationships
   ...
   walk over :class:`~chaos.models.registry.AssetRelationship`, not a
...
from chaos.alarms.definitions import correlation_settings, definition_meta
...
from chaos.models.alarms import Alarm, AlarmDefinition, Incident
